...
import generateComponentStory from 'scripts/templates/component-story';
import generateComponentMockData from 'scripts/templates/component-mock-data';
...
export interface ScaffoldComponentPluginConfig {
  ...
  storyTemplateGenerator: (componentName: string) => string;
  mockTemplateGenerator: (componentName: string) => string;
  args: string[];
  nextSteps: string[];
}
...
const defaultConfig: ScaffoldComponentPluginConfig = {
  ...
  storyTemplateGenerator: generateComponentStory,
  mockTemplateGenerator: generateComponentMockData,
  args: args,
  nextSteps: [],
};
